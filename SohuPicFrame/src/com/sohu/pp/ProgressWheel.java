...
public class ProgressWheel extends View {
	...
	// Shader Enable and Pause Flag
	// Author:Wang Wang
	private boolean barShaderEnable = false;
	...
	private void setupPaints() {
		...
		// Author:Wang Wang
		if (barShaderEnable) {
			Shader mShader = new SweepGradient(circleBounds.centerX(),
					circleBounds.centerY(), new int[] { 0xFFFF0000, 0xFFFF00FF,
	...
	private void setupBounds() {
		...
		// barWidth --> barWidth / 2
		// Author:Wang Wang
		circleBounds = new RectF(paddingLeft + barWidth / 2, paddingTop
		...
		// barWidth --> barWidth / 2
		// Author:Wang Wang
		circleRadius = (fullRadius - barWidth / 2) + 1;
	}
	...
	private void parseAttributes(TypedArray a) {
		...
		// Shader Enable
		// Author:Wang Wang
		barShaderEnable = a.getBoolean(R.styleable.ProgressWheel_barShader,
				barShaderEnable);
	...
	protected void onDraw(Canvas canvas) {
		...
		canvas.drawCircle((circleBounds.width() / 2) + rimWidth / 2
				+ paddingLeft, (circleBounds.height() / 2) + rimWidth / 2
				+ paddingTop, circleRadius, circlePaint);
		// Draw the text (attempts to center it horizontally and vertically)
		// drawText y坐标增加(textSize/2)，文本竖直方向居中
		// Author:Wang Wang
		int offsetNum = 0;
	...
	public boolean isBarShaderEnable() {
		return barShaderEnable;
	}

	public void setBarShaderEnable(boolean barShaderEnable) {
		this.barShaderEnable = barShaderEnable;
	}
